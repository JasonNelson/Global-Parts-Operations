...
ActiveRecord::Schema.define(version: 20151121182711) do
  ...
  add_index "order_lines", ["inventory_item_id"], name: "index_order_lines_on_inventory_item_id"
  add_index "order_lines", ["sales_order_id"], name: "index_order_lines_on_sales_order_id"
  ...
  add_index "sales_orders", ["customer_account_id"], name: "index_sales_orders_on_customer_account_id"
  ...
  add_index "so_pick_lists", ["order_line_id"], name: "index_so_pick_lists_on_order_line_id"
  add_index "so_pick_lists", ["sales_order_id"], name: "index_so_pick_lists_on_sales_order_id"
  ...
  add_index "so_shipments", ["customer_account_id"], name: "index_so_shipments_on_customer_account_id"
  add_index "so_shipments", ["sales_order_id"], name: "index_so_shipments_on_sales_order_id"
